...
\x1b[93;1m Github       \x1b[92;1m=>         \x1b[93;1mDareDevil
...
def menu(): #Devil
	...
	print("""%s \33[1;32m[1] File Cracking  """%(h))
...
def passwrd():
	...
	print(x+'   Use Airplane Mode Before using\n   Cracking Has Started...')
...
def crack2(idf,pwv):
	...
	print('\r%s [Devil] %s/%s  OK*%s | CP*%s => %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
